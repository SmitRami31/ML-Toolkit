"""
Enhanced categorical data handling for the ML Model Comparison Streamlit App
This module provides specialized functions for handling categorical data
"""
...
def identify_categorical_columns(df):
    """
    Identify categorical columns in a DataFrame with enhanced detection
...
def encode_categorical_features(df, categorical_columns=None, encoding_method='auto', max_categories=10):
    """
    Encode categorical features with specified method
    ...
    categorical_columns : list, optional
        List of categorical column names. If None, will be automatically detected.
    encoding_method : str, optional
        Encoding method: 'auto', 'label', 'onehot', or 'target'
...
def handle_mixed_data_types(df, column):
    ...
    --------
    tuple
        (processed_series, transformation_info)
    """
    # Make a copy to avoid modifying the original
...
def handle_high_cardinality_categorical(df, column, max_categories=20, method='frequency'):
    ...
    method : str, optional
        Method to handle high cardinality: 'frequency', 'clustering', or 'hash'
...
def encode_text_features(df, text_columns, max_features=100):
    """
    Encode text features using bag of words and dimensionality reduction
    ...
    max_features : int, optional
        Maximum number of features for bag of words
...
def suggest_target_encoding(df, target_column, categorical_columns=None):
    """
    Suggest appropriate encoding for target column based on data analysis
    ...
    --------
    dict
        Encoding suggestion with details
    """
    # Get target series
